...
The Second output is a .zip artifact composed of pdfs from both english and non-english languages. This can be found by going to the workflow and viewing the build summary.
