...
#
### Crowdin Sync
Crowdin is a business that provides translation software for its users. Crowdin has also created a Github workflow integration that allows Github workflows to send and receive files from Crowdin projects. This integration syncs this GitHub repo with its Crowdin project, allowing translations to be created and downloaded into a branch named "translations."
...
`CROWDIN_GITHUB_TOKEN:` To generate this click on the user's Github profile picture and select "settings".
